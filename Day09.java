//寻找第K大
public class Finder {
public int findKth(int[] a, int n, int K) { return findKth(a, 0, n-1, K);
}
public int findKth(int[] a, int low, int high, int k) { int part = partation(a, low, high);
...
public int partation(int[] a, int low, int high) { int key = a[low];
while(low < high) {
